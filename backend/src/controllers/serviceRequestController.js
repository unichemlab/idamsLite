 ...
 *   get:
 *     summary: Get a single service request with its tasks
 *     tags: [ServiceRequests]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *     responses:
 *       200:
 *         description: A service request with tasks
 *   put:
 ...
 * /api/service-requests/{id}/attachment:
 *   get:
 *     summary: Download attachment for a service request
 *     tags: [ServiceRequests]
 *     parameters:
 *       - in: path
 *         name: id
